...
Nombre_complejo_instalacion = "Priego, Córdoba, España"
...
if st.session_state['authentication_status']:
    ...
    with col3:
        st.subheader("Priego, Córdoba, España")
...
try:
    ...
    WHERE instalacion = '869951035865579' and (datetime > NOW() - INTERVAL var_time_resolution MINUTE)
