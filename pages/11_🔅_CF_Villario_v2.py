...
# Variables
city = "Villa del Río,ES"
api = "f8b240ffa80eee036066e32f79b95124"
url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&APPID={api}&units=metric"
Nombre_complejo_instalacion = "CF Villa del Río, España"
...
if st.session_state['authentication_status']:
    ...
    with col3:
        st.subheader("Piscina Villanueva de Córdoba")
...
WHERE instalacion = 'piscina_villanueva' and (datetime > NOW() - INTERVAL var_time_resolution MINUTE)
