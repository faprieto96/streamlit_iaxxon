...
Nombre_complejo_instalacion = "Sevilla, España"
...
if st.session_state['authentication_status']:
    ...
    with col3:
        st.subheader("Toyota Hispaljarafe, Sevilla, España")
...
try:
    ...
    WHERE instalacion = '869951036721243' and (datetime > NOW() - INTERVAL var_time_resolution MINUTE)
    ...
    df_test['energia_producida'] = (df_test['TCAP'] - df_test['TAC1'])*df_test['pump']* 0.027
    ...
    st.warning("No hay datos disponibles para mostrar, estamos trabajando para traerlos. Si tienes cualquier duda contacta con el equipo técnico.")