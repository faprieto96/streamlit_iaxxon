...
Nombre_complejo_instalacion = "Villanueva de Córdoba, España"
...
if st.session_state['authentication_status']:
    ...
    with col3:
        st.subheader("Campo de Fútbol Villanueva de Córdoba")
...
WHERE instalacion = 'cfvillanueva' and (datetime > NOW() - INTERVAL var_time_resolution MINUTE)
