...
if st.session_state["username"] == 'iaxxon':
    ...
    fig.add_trace(go.Scatter(x=pd.to_datetime(df_test_temp['datetime']), y=df_test_temp['TAC1'], name='TAC1'))
    fig.add_trace(go.Scatter(x=pd.to_datetime(df_test_temp['datetime']), y=df_test_temp['TRET'], name='TRET'))
