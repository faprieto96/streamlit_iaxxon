...
Nombre_complejo_instalacion = "Aguilar, España"
...
if st.session_state['authentication_status']:
    ...
    with col3:
        st.subheader("Huerto Vegga Pabellón, Granada")
...
try:
    ...
    WHERE instalacion = '869951035893563' and (datetime > NOW() - INTERVAL var_time_resolution MINUTE)
    ...
    st.warning("No hay datos disponibles para mostrar, estamos trabajando en ello.")